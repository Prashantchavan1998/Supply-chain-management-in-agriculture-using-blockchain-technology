                ...
                <div class="sparkline13-list shadow-reset">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <h1>My  <span class="table-project-n">Transactions</span> </h1>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="false" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="false" data-show-toggle="false" data-resizable="false" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="false" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        String sql = "SELECT * FROM tbl_transactions WHERE sender_id='" + aes.encrypt( email) + "' or receiver_id='" + aes.encrypt( email) + "'";
                                        ...
                                        while (rs.next()) {
                                            String status = "";
                                            String email1="";
                                            if (rs.getString("receiver_id").equals(email)) {
                                                    status="Received";
                                                    email1=rs.getString("sender_id");
                                                }else
                                            {
                                                status="Send";
                                                email1=rs.getString("receiver_id");
                                            }
                                    %>
                                    <tr>

                                        <td><%=i%></td>
                                        <td><%=aes.decrypt(email1)%></td>
