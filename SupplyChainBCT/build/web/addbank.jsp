                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="all-form-element-inner">
                                        <form action="AddBank" onsubmit="return post_validation()">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Account No</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">IFSC</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Bank Address</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="login-horizental cancel-wp pull-left">
                                                                ...
                                                                <input class="btn btn-sm btn-primary login-submit-cs" type="submit" value="Add Bank">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
