...
<%
    ...
    String crop_name = request.getParameter("id");
%>
                ...
                <div class="sparkline13-list shadow-reset">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <h1>My  <span class="table-project-n">Inventory</span> </h1>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="false" data-show-pagination-switch="false" data-show-refresh="false" data-key-events="false" data-show-toggle="false" data-resizable="false" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="false" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="action">Send Request</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
                                        DBConnection db = new DBConnection();
                                        String sql = "SELECT * FROM tbl_invertory_details ti inner join tbl_users tu on ti.agent_id=tu.email WHERE ti.agent_id!='" + email + "' AND ti.inventory_name='" + crop_name + "'";
                                    ...
                                    <tr>
                                        ...
                                        <td><%=rs.getString("inventory_rate")%></td>
                                        <td><%=rs.getString("quantity")%></td>
                                        <td><%=rs.getString("inventory_status")%></td>


                                        <td class="datatable-ct"><a href="request_inventory_next.jsp?id=<%=aes.decrypt(rs.getString("inventory_name"))%>&agent_id=<%=aes.decrypt(rs.getString("email"))%>" onclick="return confirm('Do you want to send request?')"><i class="fa fa-reorder"></i> </a></td>
